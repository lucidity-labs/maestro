...
public class Repo {
    ...
    public static void insertEvent(EventEntity event) {
        String query = "INSERT INTO event (id, workflow_id, run_id, entity, class_name, function_name, input_data, output_data, status) " +
                "VALUES (?, ?, ?, ?::entity, ?, ?, ?::json, ?::json, ?::status)";
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            preparedStatement.setString(4, event.entity().name());
